...
o3v.Label = function (inputHandler, selectManager, renderInterface, canvas, labelContainer, navigator, gestures) {
    ...
    this.types_[o3v.Label.TYPE_PIN_EXPANDABLE_] = { className: 'label_pin_expandable' };
